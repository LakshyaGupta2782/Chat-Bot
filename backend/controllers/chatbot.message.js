  ...
  try {
    ...
    if (!botResponse) {
      try {
        ...
        botResponse = response.text() || "Sorry, I don't understand that!!!";
      } catch (geminiError) {
        console.log("Gemini API Error:", geminiError);
        botResponse = "Sorry, I couldn't fetch a response from Gemini.";
      }
    }
